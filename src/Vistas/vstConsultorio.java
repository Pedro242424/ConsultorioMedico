 ...
 * @author kiwic
 */
public class vstConsultorio extends javax.swing.JFrame {

    /**
     * Creates new form vstConsultorio
     */
    public vstConsultorio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Mario.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vstConsultorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vstConsultorio().setVisible(true);
            }
        });
    }
